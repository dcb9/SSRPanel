...
class SubscribeController extends Controller
{
    ...
    public function index(Request $request, $code)
    {
        ...
        // 控制客户端最多获取节点数
        $scheme = "MAX=".((int)self::$systemConfig['subscribe_max'])."\n";
    ...
    {
        return base64url_encode('MAX=1'."\n".'ssr://' . base64url_encode('8.8.8.8:8888:origin:none:plain:' . base64url_encode('0000') . '/?obfsparam=&protoparam=&remarks=' . base64url_encode('无可用节点或账号被封禁或订阅被封禁') . '&group=' . base64url_encode('VPN') . '&udpport=0&uot=0') . "\n");
    }
}
